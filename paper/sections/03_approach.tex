...
for the K value grid selection are provided in \cref{sec:rq1}. The maximum sequence length is set to 8,192 tokens.\footnote{Maximum sequence length is selected empirically. 8,192 tokens offered the best trade-off between classification accuracy and inference speed across our preliminary experiments.} Roughly 30\% of the
