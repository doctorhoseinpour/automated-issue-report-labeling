...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{esem/figures/app_ov.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fao.pdf}
    \caption{Overview of the four IRC approaches evaluated in this paper: \votag, \ragtag, \bragtag, and the LoRA fine-tuning baseline.}
    \label{fig:approach-overview}
\end{figure}
...
classified examples in the prompt. \Cref{sec:approach-bragtag} elaborates on \bragtag's balanced retrieval intervention on \ragtag. Finally, \Cref{sec:finetune} details the faithful reproduction of the fine-tuning baseline.
