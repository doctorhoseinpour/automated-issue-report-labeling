...
\Cref{tab:method-comparison} reports macro and per-class $F_1$ at each method's best configuration with the fallback applied. \ragtag has competitive macro $F_1$ with fine-tuning: aggregated across the four model sizes (13{,}200 paired predictions), fine-tune leads \ragtag\ by only 0.020 macro $F_1$ (paired bootstrap 95\% CI $[-0.028, -0.013]$). \ragtag\ is closer to fine-tune at the smallest and largest models and farther in the middle, with per-model (\ragtag\ $-$ fine-tune) macro $F_1$ deltas (paired bootstrap 95\% CIs in brackets) of $-0.015$ [$-0.032, +0.002$] (Qwen-3B), $-0.033$ [$-0.047, -0.017$] (Qwen-7B), $-0.039$ [$-0.054, -0.025$] (Qwen-14B), and $+0.008$ [$-0.008, +0.022$] (Qwen-32B). \ragtag\ and fine-tune are statistically tied at Qwen-32B.
