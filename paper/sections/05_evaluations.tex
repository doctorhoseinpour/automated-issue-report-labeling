...
\subsection{RQ1.\ How effectively can retrieval alone classify issue reports, and at what point does adding more retrieved neighbors stop helping?}
\label{sec:rq1}
\begin{figure}[t]
    \centering
...
\subsection{RQ2. How well does retrieval-augmented few-shot prompting classify issue reports, and how does performance vary with the number of in-context examples?}
\label{sec:ragtag}
...
\subsection{RQ3. Can a balanced retrieval intervention reduce question-to-bug misclassification and improve retrieval-augmented few-shot performance?}
\label{sec:bragtag}
...
\subsubsection{Computation and Data Cost.}
