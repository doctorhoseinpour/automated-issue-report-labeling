\begin{table*}[t]
  \centering
  \caption{\ragtag, \bragtag, and LoRA fine-tuning at each method's best configuration: \ragtag/\bragtag\ at their best $k$ under the PS data scope, and LoRA fine-tuning under the PA data scope. The +\votag\ column reports macro $F_1$ after using \votag\ as a fallback for invalid LLM outputs. Train and inference denote runtimes, with total runtime computed as their sum. RAM denotes the observed peak GPU memory.}
